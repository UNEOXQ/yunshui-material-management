...
interface FinishedMaterialCardProps {
  material: Material;
  onAddToCart: (material: Material, quantity: number) => void;
  cartQuantity: number;
}

export const FinishedMaterialCard: React.FC<FinishedMaterialCardProps> = ({
  material,
  onAddToCart,
  cartQuantity
}) => {
  ...
  return (
    <div className={`material-card finished-material-card ${isOutOfStock ? 'out-of-stock' : ''}`}>
      <div className="card-image">
        ...
        <div className="type-badge type-finished">
          完成材
        </div>
      </div>
      ...
      <div className="card-content">
        ...
        <div className="card-details">
          ...
          {/* Prominent supplier information for finished materials */}
          <div className="supplier-info-prominent">
            <div className="supplier-label">供應商</div>
            <div className="supplier-name">
              {material.supplier || '未指定供應商'}
            </div>
          </div>
        </div>
